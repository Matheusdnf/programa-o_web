...
async function requisicao(busca: String, tipo: string) {
  ...
  const res = await fetch(
    `http://www.omdbapi.com/?i=tt3896198&apikey=9eabd38d&s=${titleSearchKey}&type=${tipoSearchky}`
  );
...
export default function Home() {
  return (
    <div>
      <div>
        <div>{requisicao("avengers", "series")}</div>
        <h1>Viva Santana!</h1>
        ...
        <Link href="/busca_filme">Formulário</Link> <br />
